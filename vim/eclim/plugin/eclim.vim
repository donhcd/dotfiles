...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/donhuang/.eclipse/org.eclipse.platform_3.7.0_1473617060/plugins/org.eclim_1.7.1'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/donhuang/.eclipse/org.eclipse.platform_3.7.0_1473617060'
  if has('win32unix')
